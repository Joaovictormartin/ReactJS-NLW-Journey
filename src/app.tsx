    ...
    <div className="h-screen flex items-center justify-center bg-pattern bg-no-repeat bg-center">
      <div className="max-w-3xl w-full px-6 text-center space-y-10">
        ...
        <p className="text-sm text-zinc-500">
          ...
          com a nossos <a className="text-zinc-300 underline" href="/">termos de uso</a> e <a className="text-zinc-300 underline" href="/">políticas de privacidade</a>.
        </p>
      </div>
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center">
          <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900">
            <div className="flex items-center justify-between">
              ...
              <X onClick={closeGuestsModal} className="text-zinc-400 size-5"/>
            </div>
          </div>
        </div>
      )}
